...
function createStage1(): LevelData {
  ...
  return {
    ...
    stageNumber: 1,
    title: "Nebula Garden",
    tagline: "スタンダードな銀河草原。地形の基本を覚えるステージ",
    width,
    height: 540,
    deathY: 760,
    spawn: { x: 80, y: 440 },
...
function createStage2(): LevelData {
  ...
  return {
    ...
    tagline: "常時逆風。地上は分断され、連続ジャンプが必要",
    width,
    height: 560,
    deathY: 780,
    spawn: { x: 70, y: 452 },
...
function createStage4(): LevelData {
  ...
  return {
    ...
    stageNumber: 4,
    title: "Lunar Drift",
    tagline: "低重力と追い風。浮遊島を使って大きく移動する",
    width,
    height: 860,
    deathY: 1030,
    spawn: { x: 80, y: 682 },
...
function createStage5(): LevelData {
  ...
  return {
    ...
    stageNumber: 5,
    title: "Alien Armada",
    tagline: "高重力・高速敵の最終戦。短距離判断で押し切る",
    width,
    height: 620,
    deathY: 840,
    spawn: { x: 80, y: 512 },
